    ...
    $.addcalevent.prototype = {
		...
		*/
        ...
        _getUrl_ics: function() {
            ...
            url += '&desc=' + encodeURIComponent(document.getElementById("histoabs").innerText);
        ...
        _getUrl_google: function() {
            ...
            url += '&details=' + encodeURIComponent(document.getElementById("histoabs").innerText);
        ...
        _getUrl_hotmail: function() {
            ...
            url += '&description=' + encodeURIComponent(document.getElementById("histoabs").innerText);
            return url;
        },
