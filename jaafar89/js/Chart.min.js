...
function fireCharts() {
	...
	var speedData = {
		...
		labels: ["Restaurant site", "Other sites (average)"],
        datasets: [
    ...
    var conversionData = {
		...
		labels: ["Desktop", "Mobile - Pocket Diner", "Desktop on mobile"],
    	datasets: [
    ...
    var timeData = {
	    ...
	    datasets: [

		    {
		    	...
		    	highlightFill: "rgba(220,220,220,0.75)",
		    	highlightStroke: "rgba(220,220,220,1)",
		        data: [20145,21224,23563,32826,26339,19776,19341]
		    },
		    {
		        label: "desktop (anomolised)",
		        fillColor: "rgba(151,187,205,0.5)",
		        strokeColor: "rgba(151,187,205,0.8)",
		        highlightFill: "rgba(151,187,205,0.75)",
		        highlightStroke: "rgba(151,187,205,1)",

		        data: [20000,20400,21000,19500,19800,19000,20000]
		    }
    	]
    }
	...
	var ctx = document.getElementById("chart-phone").getContext("2d");
	window.myDoughnut = new Chart(ctx).Doughnut(phoneData, {responsive : false,tooltipTemplate: "<%if (label){%><%=label%>: <%}%><%= value %>%"});

	var ctx = document.getElementById("chart-browser").getContext("2d");
	window.myDoughnut = new Chart(ctx).Doughnut(browserData, {responsive : false,tooltipTemplate: "<%if (label){%><%=label%>: <%}%><%= value %>%"});

	var ctx = document.getElementById("chart-speed").getContext("2d");
	window.myDoughnut = new Chart(ctx).Bar(speedData, {responsive : false,scaleShowLabels: true, multiTooltipTemplate: "<%= datasetLabel %> - <%= value %>%"});

	var ctx = document.getElementById("chart-conversion").getContext("2d");
	window.myDoughnut = new Chart(ctx).Bar(conversionData, {responsive : false,scaleShowLabels: true, tooltipTemplate: "<%= label %> - <%= value %>%"});

	var ctx = document.getElementById("chart-time").getContext("2d");
	window.myDoughnut = new Chart(ctx).Line(timeData, {responsive : false,scaleShowLabels: true, multiTooltipTemplate: "<%= datasetLabel %> - <%= value %> visits"});

	var ctx = document.getElementById("chart-gender").getContext("2d");
	window.myDoughnut = new Chart(ctx).Doughnut(genderData, {responsive : false,tooltipTemplate: "<%if (label){%><%=label%>: <%}%><%= value %>%"});

	var ctx = document.getElementById("chart-age").getContext("2d");
	window.myDoughnut = new Chart(ctx).Line(ageData, {responsive : false,scaleShowLabels: true, tooltipTemplate: "<%= Label %> - <%= value %>%"});
